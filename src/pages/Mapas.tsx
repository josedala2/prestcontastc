...
const modelos = [
  ...
  { code: "2", name: "Mapa dos Subsídios Recebidos", status: "pendente" },
  ...
  { code: "6", name: "Mapa dos Empréstimos Obtidos", status: "pendente" },
  ...
  { code: "10", name: "Relação Nominal dos Responsáveis", status: "pendente" },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {modelos.map((m) => (
          <div key={m.code} className="bg-card rounded-lg border border-border card-shadow p-5 flex items-center gap-4 animate-fade-in">
            ...
            <Button variant="outline" size="sm" onClick={() => setActiveModel(m.code)}>
              Preencher
            </Button>
          </div>
        ))}
